...
import { getIncomingRequests } from "../../services/userService/apiRequests";
...
export function useIncomingRequests() {
  ...
  let {
    ...
    queryKey: ["inrequests" /* search, */ /* filter */ /* sortBy */, page],
    queryFn: () => getIncomingRequests(Number(localStorage.getItem("userId"))),
  });
